---
layout: post
title: "[LLM] Deal with Extrinsic Hallucinations in LLMs (1)"
excerpt: "To avoid hallucination, LLMs need to be (1) factual and (2) acknowledge not knowing the answer when applicable."
category: Others
date: 2024-07-15
tags: [blog]
description: "Y."
comments: true
# external_url: "https://lilianweng.github.io/posts/2024-07-07-hallucination/"
---
...
[This post](https://lilianweng.github.io/posts/2024-07-07-hallucination/) focuses on extrinsic hallucination. To avoid hallucination, LLMs need to be (1) factual and (2) acknowledge not knowing the answer when applicable.