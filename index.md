...
- Developed a software for embedding a neural network inference pipeline into an existing medical imaging system for 4x faster MRI scans.
- Built a framework to asynchronously schedule tasks during deep learning data preprocessing with 4x performance improvement in parallel request query.
